  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 flex w-full flex-col bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out",
          side === "left" || side === "right" ? "h-full max-w-xl" : "max-h-screen",
          sideClasses[side],
          className,
        )}
        {...props}
